...
import com.ifound.appointment.presentation.navigation.appointmentNavigation
...
import com.ifound.stores.presentation.navigation.storesNavigation
...
fun IfoundNavHost() {
    ...
    NavHost(navController, startDestination = Routes.SignBaseRoute) {
        ...
        storesNavigation(navController)
